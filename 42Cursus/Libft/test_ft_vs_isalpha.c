...
int main(void) {
    ...
    int whiteSpace1, whiteSpace2, whiteSpace3, whiteSpace4;     whiteSpace1 = 32; // Espacio simple     whiteSpace2 = 9; // Tabulación horizontal     whiteSpace3 = 11; // Tabulación vertical     whiteSpace4 = 12; // Tabulación de formato  

    int ws1Result, ws2Result, ws3Result, ws4Result;       ws1Result= ft_isalpha(whiteSpace1);       ws2Result= ft_isalpha(whiteSpace2);       ws3Result= ft_isalpha(whiteSpace3);       ws4Result= ft_isalpha(whiteSpace4);  
